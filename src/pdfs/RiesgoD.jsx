...
const RiesgoD = ({ formularioUno = {}, formularioTres = {}, formularioCuatro = {}, formularioCinco = {}, formularioSeis = {}, score = 0, rango = '', }) => {
        ...
        <Document>
            <Page size={'A4'} style={styles.page}>
                ...
                <View style={{ marginTop: '10px', padding: '20px' }}>
                    <Text style={styles.h1}>Categoría D de riesgo y primer nivel o segundo nivel</Text>
                    ...
                    <View style={{ marginTop: '20px' }}>
                        ...
                        <Text style={styles.p} >
                            Neonato de apellido materno <Text style={{ fontWeight: 'bold', fontSize: '15px' }}>{formularioUno.apellidoMaterno}</Text>, es un neonato de Categoría de riesgo D: tiene bajas probabilidades de eventos adversos neonatales.
                        </Text>
                        <Text style={styles.p} >
                        ...
                        <Text style={styles.p} >
                            Si el neonato está estable y ha cumplido, al menos, 48 horas de vida cuando el nacimiento fue por parto normal; o, 72 horas de vida cuando ha sido por cesárea, proceda a dar el alta de calidad conforme la normativa vigente, y previa evaluación de un médico.
                        </Text>
                        <Text style={styles.p} >
                            Oriente a la madre en lactancia materna exclusiva, cuidados del recién nacido en el hogar; en caso de prematurez o peso bajo, orientar de los cuidados extra (ver las páginas 53, 54 y 55 del AIEPI Clínico <Link src="http://186.42.188.158:8090/guias/AIEPI%20CLINICO.%20CUADROS%20DE%20PROCEDIMIENTOS.pdf" style={{color:'#60a5fa'}}> Link </Link>); y control entre el tercer a quinto día de vida o cuarenta y ocho a setenta y dos horas después del alta del recién nacido, previa notificación al establecimiento de salud para atención preferencial.
                        </Text>
                        <Text style={styles.p} >
                            Es importante tomar en cuenta que la muestra para tamizaje metabólico neonatal se debe tomar a partir del cuarto hasta los 28 días de vida del recién nacido.
                        </Text>
                        <Text style={styles.p} >
                            Si el neonato cumple con alguno de los “Factores que podrían incrementar el riesgo neonatal”, requiere una visita domiciliaria por parte de un médico del primer nivel, dentro de los 2 a 3 días de vida, o 24 a 48 horas del alta.
                        </Text>
                    </View>
                </View>
            </Page>
