            ...
            <Page size={'A4'} style={styles.page}>
                ...
                <View style={{ marginTop: '10px', padding: '20px' }}>
                    ...
                    <View style={{ border: '1px solid #e7e5e4', display: 'flex', justifyContent: 'space-between', flexDirection: 'row', gap: '30px', padding: '20px' }}>
                        <View style={{ flex: '1' }}>
                            <Text style={styles.h2}>Categoría de riesgo B</Text>
                            <View>
                                <Image src={caution} style={{ width: '85px', height: '70px' }} />
                            </View>
                            <View >
                                <Text style={styles.h3}>Riesgo moderado </Text><Text style={styles.p}>de muerte neonatal pues tiene un puntaje ≥ 72 y &lt; 77 puntos.</Text>
                            </View>
                            <View style={styles.infoItem}>
                                <Text style={styles.p}>Tiene más de un 77% más probabilidades de muerte neonatal que los niños de la categoría C (bajo riesgo).</Text>
                            </View>
                        </View>
                        <View style={{ flex: '1' }}>
