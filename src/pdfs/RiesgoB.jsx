...
const RiesgoB = ({ formularioUno = {}, formularioTres = {}, formularioCuatro = {}, formularioCinco = {}, formularioSeis = {}, score = 0, rango = '', }) => {
        ...
        <Document>
            <Page size={'A4'} style={styles.page}>
                ...
                <View style={{ marginTop: '10px', padding: '20px' }}>
                    <Text style={styles.h1}>Categoría B de riesgo y primer nivel o segundo nivel</Text>
