                    ...
                    <View style={{ border: '1px solid #e7e5e4', padding: '20px' }}>
                        <View style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', gap: '30px', }}>
                            <View style={{ flex: '1', display: 'flex', justifyContent: 'center' }}>
                                <Text style={[styles.h2, { textAlign: 'center' }]}>Score Bebé categoría A:</Text>
                                <View>
                                    <Image src={warning} style={{ display: 'block', margin: 'auto', width: '105px', height: '100px' }} />
                                </View>
                            </View>
                            <View style={{ flex: '1', display: 'flex', justifyContent: 'center' }}>
                        ...
                        <View >
                            <Text style={styles.p}>Neonato/a con alto riesgo de resultados graves en salud neonatal.</Text><Text style={styles.h3}>TIENE UNA ENFERMEDAD MUY GRAVE: </Text>
                            <Text style={styles.p}> &gt; 4 veces más probabilidades de resultados graves en salud neonatal que los niños de bajo riesgo. Requiere estabilización inmediata. Como usted lo/a atiende en primer o segundo nivel de atención:
                            </Text>
                        </View>
                    </View>
